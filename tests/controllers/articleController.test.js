...
describe('Articles API endpoints', () => {
  ...
  it('Should get articles by fiction', (done) => {
    chai.request(app)
      ...
      .end((err, res) => {
        ...
        expect(res.body).to.have.property('articles').to.be.an('array');
        done();
      });
  });

  it('Should not find articles by title', (done) => {
    chai.request(app)
