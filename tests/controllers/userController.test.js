...
describe('Tests for user registration and log in', () => {
  ...
  it('Should not login unverified user incorrect email', (done) => {
    chai.request(app)
      .post('/api/users/login')
      .send({
        user: {
...
describe('Resend Verification', () => {
  ...
  it('Should not send verification email to a verified user or invalid user', (done) => {
    chai.request(app)
...
describe('Tests for user profile', () => {
  ...
  it('Should not update profile if no token is suppliedxxxx', (done) => {
    chai.request(app)
      .put('/api/profiles/asdfghjkl')
      .send({
        user: {
